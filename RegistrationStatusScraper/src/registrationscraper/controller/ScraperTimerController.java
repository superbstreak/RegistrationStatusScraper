...
public class ScraperTimerController {
  ...
  private void scrapeStatus(AClass interest) throws IOException {
    ...
    if (remaining != null && !remaining.isEmpty()) {
      ...
      if (remain > 0) {
        System.out.println("> TimeStamp: "+ new Date() +", "+ interest.getClassIdentifier()+" "+interest.getSectionIdentifier()+": "+remain+" remaining! GET IT NOW! <-------------------");
